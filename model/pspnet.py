...
class PSPNet(nn.Module):
    def __init__(self, in_class=1, n_classes=1, sizes=(1, 2, 3, 6), psp_size=512, deep_features_size=1024,
                 backend='resnet34',
                 pretrained=True):
        super().__init__()
    ...
    def forward(self, x):
        ...
        return nn.Sigmoid()(self.final(p))


if __name__ == '__main__':
    inputs = torch.ones(4, 3, 256, 256)
    model = PSPNet(in_class=3, n_classes=1)
